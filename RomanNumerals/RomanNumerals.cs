...
namespace RomanNumerals
{
    ...
    {
        public static List<int> arabicRepresentation = new List<int> { 15, 14, 10, 9, 5, 4, 1 };
        public static List<string> romanRepresentation = new List<string> { "XV", "XIV", "X", "IX", "V", "IV", "I" };
